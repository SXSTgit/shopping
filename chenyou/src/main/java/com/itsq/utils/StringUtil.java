...
public class StringUtil {
     ...
     * @return
     */
    public static String subStrRight(String value, int needLength) {

        value = fillZero(value,needLength);

        if (value.length() > needLength) {
            return value.substring(value.length() - needLength,value.length());
        }
