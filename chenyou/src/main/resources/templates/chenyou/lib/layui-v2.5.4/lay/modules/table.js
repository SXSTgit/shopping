...
layui.define(["laytpl", "laypage", "layer", "form", "util"],
    function(e) {
        ...
        I.prototype.config = {
            ...
            autoSort: !0,
            text: {
                none: "<img style='margin: 100px auto;' src='../../images/queshengtu1.svg' />"
            }
        },
            I.prototype.render = function() {
                ...
                if (a.index = e.index, e.key = a.id || a.index, n[0] && n.remove(), l.after(o), e.layTool = o.find(m), e.layBox = o.find(g), e.layHeader = o.find(x), e.layMain = o.find(C), e.layBody = o.find(k), e.layFixed = o.find(w), e.layFixLeft = o.find(T), e.layFixRight = o.find(A), e.layTotal = o.find(L), e.layPage = o.find(N), e.renderToolbar(), e.fullSize()) {
